    ...
    private void SwitchWeapon()
    {
        switch (ActiveWeapon)
        {
            case Weapons.Weaponless:
                m_SwordSprite.SetActive(false);
                m_ScepterSprite.SetActive(false);
                m_ShieldsSprite.SetActive(false);
                break;
            case Weapons.Shields:
                m_SwordSprite.SetActive(false);
                m_ScepterSprite.SetActive(false);
                m_ShieldsSprite.SetActive(true);
                break;
            case Weapons.Scepter:
                m_SwordSprite.SetActive(false);
                m_ScepterSprite.SetActive(true);
                m_ShieldsSprite.SetActive(false);
                break;
            case Weapons.Sword:
                m_SwordSprite.SetActive(true);
                m_ScepterSprite.SetActive(false);
                m_ShieldsSprite.SetActive(false);
                break;
        }
