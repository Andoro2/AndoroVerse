...
public class CharacterController : MonoBehaviour
{
    ...
    //WEAPONS POSITIONING
    private GameObject m_ShieldRDrawn, m_ShieldRSaved, m_ShieldLDrawn, m_ShieldLSaved, m_Sword, m_SwordBoneSaved, m_SwordBoneDrawn, m_Scepter, m_ScepterBoneDrawn;
    //WEAPONS VFX
    ...
    private void OnEnable()
    {
        ...
        playerInputActions.Actions.RangeAttack.canceled += OnScepterHeavyCanceled;
    }
    ...
    private void Start()
    {
        ...
        m_VP = GameObject.FindWithTag("UI").gameObject.transform.GetChild(0).GetComponent<VideoPlayer>();
    }
    private void Update()
    {
    ...
    private void OnScepterHeavyCanceled(InputAction.CallbackContext context)
    {
        GameObject ScepterHeavy = transform.Find("Body/Weapons/ScepterHeavyVFX").gameObject;
    ...
    //private List<SkinnedMeshRenderer> m_WeaponsMesh = new List<SkinnedMeshRenderer>();
