...
public class NPCWalk : MonoBehaviour
{
    ...
    private int m_CheckpointActive;//, m_MissionSaved;
    ...
    void Start()
    {
        ...
        m_CheckpointActive = GM.m_CheckPointIndex;
    }

    void Update()
    {
        if(m_CheckpointActive != GM.m_CheckPointIndex)
        {
            m_CheckpointActive = GM.m_CheckPointIndex;
        ...
        foreach (MissionPath Ruta in m_MissionPaths)
        {
            ...
            if(Ruta.m_MissionIndex == GM.m_CheckPointIndex)
            {
